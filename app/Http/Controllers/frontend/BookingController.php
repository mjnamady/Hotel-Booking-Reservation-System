...
class BookingController extends Controller
{
    ...
    public function UpdateBookingStatus(Request $request, $id){
        ...
        $data = [
            'check_in' => $sendMial->check_in,
            'check_out' => $sendMial->check_out,
            'name' => $sendMial->name,
            'email' => $sendMial->email,
            'phone' => $sendMial->phone
        ];

        // dd($sendMial->email);

        Mail::to($sendMial->email)->send(new BookConfirm($data));
