...
class RoomListController extends Controller
{
    public function ViewRoomList(){
        ...
        $room_number_list = RoomNumber::with(['room_type','last_booking.booking:id,rooms_id,user_id,check_in,check_out,status,code,name,phone'])->orderBy('room_type_id','asc')
        ...
        return view('backend.allrooms.roomlist.view_roomlist',compact('room_number_list'));
    } // End Method

    public function AddRoomList(){

        $roomtype = RoomType::all();
        return view('backend.allrooms.roomlist.add_roomlist',compact('roomtype'));
    ...
    public function StoreRoomList(Request $request){
        ...
        if ($request->check_in == $request->check_out) {
            $request->flash();
            $notification = array(
                'message' => 'Check In/Out cannot be thesame!',
                'alert-type' => 'error'
            );
