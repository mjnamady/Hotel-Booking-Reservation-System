...
<div class="page-content">
    ...
    @endif
              ...
              <form method="post" action="{{ route('update.booking.status',$editData->id) }}">
                @csrf
            ...
            <div class="col-md-12" style="margin-top: 20px;">
                ...
                <a href="{{route('download.invoice', $editData->id)}}" class="btn btn-warning" style="border-radius: 10px"> <i class="lni lni-download"></i> Download Invoice</a>
            </div>
