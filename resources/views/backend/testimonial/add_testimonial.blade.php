                        ...
                        <div class="card-body">
                            <form id="myForm" method="POST" action="{{ route('store.testimonial') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <textarea class="form-control" name="message" id="input11" placeholder="Message ..." rows="3"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Upload Testimonial" />
                                    </div>
                                </div>
                            </form>
                        </div>
