                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <h5 class="mb-4">Add Admin User </h5>
                            <form class="row g-3" method="POST" action="{{route('store.admin.user')}}">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    <label for="input2" class="form-label">Admin User Password </label>
