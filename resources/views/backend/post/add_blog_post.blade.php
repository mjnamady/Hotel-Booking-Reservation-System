                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form class="row g-3" method="POST" id="myForm" action="{{route('store.blog.post')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="post_title" class="form-control" id="input2">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="long_desc" id="mytextarea"></textarea>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        ...
                                        <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="Blog Image" class="rounded-circle p-1 bg-primary" width="80">
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        <button type="submit" class="btn btn-primary px-4">Upload Post</button>
                                    </div>
                                </div>
                            </form>
                        </div>
