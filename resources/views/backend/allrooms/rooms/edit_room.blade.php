...
<div class="page-content">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#primaryhome" role="tab" aria-selected="true">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="tab-title">Manage Rooms</div>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                ...
                                <div class="col-xl-12 mx-auto">
                                    ...
                                    <div class="card">
                                        <div class="card-body p-4">
                                            ...
                                            <form action="{{ route('update.room',$editData->id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <img class="mt-2" src="{{ (!empty($editData->image)) ? url('upload/roomimg/'.$editData->image) : url('upload/no_image.jpg') }}" alt="" style="width:80px;height:50px;" id="showImage">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    {{-- <dir class="row" id="preview_img"></dir> --}}
                                                    <dir id="preview_img"></dir>

                                                    @foreach ($multiImgs as $image)

                                                         <img class="mt-2" src="{{ (!empty($image->multi_img)) ? url('upload/roomimg/multi_img/'.$image->multi_img) : url('upload/no_image.jpg') }}" alt="" style="width:60px;height:30;" id="showImage">

                                                         <a href="{{ route('multi.image.delete',$image->id) }}"><i class="lni lni-close"></i></a>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="short_desc" id="input11" rows="3">
                                                        {{ $editData->short_desc }}
                                                    </textarea>
                                                </div>
    ...
    <br>
       ...
       <table class="table mb-0 table-striped" id="roomview">
        ...
        <tbody>
            @foreach ($allRoomNumbers as $key => $Rnumber)
                
            <tr>
                <th scope="row">{{ $key+1 }}</th>
                <td>{{ $Rnumber->room_no }}</td>
                <td>{{ $Rnumber->status }}</td>
                <td>
                    <a href="{{ route('edit.room.no',$Rnumber->id) }}" type="button" class="btn btn-outline-warning radius-30">Edit</a>
                    <a href="{{ route('delete.room.no',$Rnumber->id) }}" id="delete" type="button" class="btn btn-outline-danger radius-30">Delete</a>
                </td>
            </tr>
