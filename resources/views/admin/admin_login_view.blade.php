								...
								<div class="">
									...
									<div class="form-body">
                                        <form class="row g-3" method="POST" action="{{ route('login') }}">
											...
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label">Email/Name/Phone No</label>
												<input type="login" name="login" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="jhon@example.com">
                                                @error('login')
