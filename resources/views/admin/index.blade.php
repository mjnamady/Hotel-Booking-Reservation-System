...
@php
  ...
  $todayRevenue = App\Models\booking::whereDate('created_at', $today)->sum('total_price');
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <p class="mb-0 font-13">Today's Revenue: ${{ $todayRevenue }}</p>
                    </div>
       ...
       <div class="col-12 col-lg-12 d-flex">
          <div class="card radius-10 w-100">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <div>
                        <h6 class="mb-0">Booking Chart</h6>
                    </div>
