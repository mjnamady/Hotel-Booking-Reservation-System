                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input autocomplete="off" required name="check_in" id="check_in" type="text" class="form-control dt_picker" value="{{ old('check_in') ? date('Y-m-d', strtotime(old('check_in'))) : '' }}">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input autocomplete="off" required name="check_out" id="check_out" type="text" class="form-control dt_picker" value="{{ old('check_out') ? date('Y-m-d', strtotime(old('check_out'))) : '' }}">
                                            <span class="input-group-addon"></span>
                                        </div>
                                        <i class='bx bxs-calendar'></i>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="persion" class="form-control" id="nmbr_person">
                                            @for ($i = 1; $i <=4; $i++)
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="number_of_rooms" class="form-control" id="select_room">
                                            @for ($i = 1; $i <= 5; $i++)
...
<div class="side-bar-list">
    <ul>
       <li>
        ...
        <li>
             <a href="#"> <b>Size : </b> {{ $roomDetails->room_size }}ft2 <i class='bx bxs-cloud-download'></i></a>
        </li>
